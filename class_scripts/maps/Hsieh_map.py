...
# Check to see if CRS are all the same
print("gages_AZ:", gages_AZ.crs, "\n")
print("major_rivers:", major_rivers_project.crs, "\n")
print("Watersheds:", Watersheds_project.crs, "\n")

# Adding in some points of interest: Stream gauge location and 
# beginning of Verde River (34.864282, -112.442660), end of Verde River
# (33.547297, -111.660554), and Phoenix AZ (33.4484,-112.0740)
